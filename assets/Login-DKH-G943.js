import{j as e,H as y,I as j}from"./ui-B8VyAbFl.js";import{t as v,z as o,A as _,F as N,a as c,b as d,c as m,d as x,e as u}from"./index-DuxIKq8m.js";import{a as k,t as i,u as S,I as h,B as F}from"./index-BJQAqHy1.js";import{u as I}from"./resolvers-BTaHPCFs.js";import{u as E,L}from"./router-BnJytTjr.js";import{r as p}from"./vendor-DG599jyl.js";import"./query-CWB_8EHL.js";const z=async a=>{try{const r=await k.post("/api/users/login",a);if(r.status===200)return i.success(r.data.message),r.data.data;throw new Error("Login failed")}catch(r){throw r.response&&r.response.data&&r.response.data.message?i.error(r.response.data.message):i.error("An unexpected error occurred."),r}},W=o.object({email:o.string().email({message:"Invalid email address"}),password:o.string().min(4,{message:"Password must be at least 6 characters"}).max(100)}),O=()=>{const[a,r]=p.useState(!1),[l,f]=p.useState(!1),g=E(),{login:w}=S(),n=I({resolver:v(W),defaultValues:{email:"",password:""}}),b=async t=>{r(!0);try{const s=await z(t);console.log("Token:",s),s&&(w(s),g("/"))}catch(s){console.error("Login failed:",s)}finally{r(!1)}};return e.jsx(_,{children:e.jsxs(N,{...n,children:[e.jsx("h1",{className:`\r
  ...
  `,children:[e.jsx("span",{className:"absolute inset-0 animate-fireWave opacity-90",style:{background:`
      ...
      `}})]})]})]})})};export{O as default};
//# sourceMappingURL=Login-DKH-G943.js.map
